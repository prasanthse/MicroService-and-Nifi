package com.ashik.kelaniya.uni.hello.impl;
...
import com.ashik.kelaniya.uni.hello.api.GreetingMessage;
import com.ashik.kelaniya.uni.hello.api.HelloService;
import com.ashik.kelaniya.uni.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<com.ashik.kelaniya.uni.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      com.ashik.kelaniya.uni.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new com.ashik.kelaniya.uni.hello.api.HelloEvent.GreetingMessageChanged(
